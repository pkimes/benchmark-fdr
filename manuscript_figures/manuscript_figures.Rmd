...
# non-null
wcs <- which(grepl("RNAseq", casestudy) & 
            !grepl(c("brain|mir|polyester|null|_uninfCov"), dataset) &
            !grepl("scRNAseq", casestudy))
objs <- objects[wcs]
labs <- gsub(".rds", "", 
             unlist(lapply(str_split(dataset[wcs], pattern = "-results-"), 
...
# null
wcs <- which(grepl("RNAseq", casestudy) & 
            !grepl(c("brain|mir|polyester|de|_uninfCov"), dataset) &
            !grepl("scRNAseq", casestudy))
objs <- objects[wcs]
labs <- gsub(".rds", "", 
             unlist(lapply(str_split(dataset[wcs], pattern = "-results-"), 
...
```{r}
wcs <- which(grepl("RNAseq", casestudy) & 
            !grepl(c("brain|mir|yeast|null|_uninfCov"), dataset) &
            !grepl("scRNAseq", casestudy))
objs <- objects[wcs]
labs <- gsub(".rds", "", 
             unlist(lapply(str_split(dataset[wcs], pattern = "-results-"), 
