...
p3a <- genplot(res_ntests, cov = as.factor(ntests), met = "FDR", ebw = 0.15) +
    xlab("Number of Tests")
p3b <- genplot(res_ntests, cov = as.factor(ntests), met = "TPR", ebw = 0.15) +
    xlab("Number of Tests")
...
p3c <- genplot(res_pi0, cov = pi0, met = "FDR", ebw = 2.5) +
    scale_x_continuous("Proportion of Null Hypotheses",
                       breaks = c(5, seq(10, 90, by = 10), 95, 99))
p3d <- genplot(res_pi0, cov = pi0, met = "TPR", ebw = 2.5) +
    scale_x_continuous("Proportion of Null Hypotheses",
                       breaks = c(5, seq(10, 90, by = 10), 95, 99))
...
Fig3 <- plot_grid(p3a + guides(color = FALSE, linetype = FALSE),
                p3b + guides(color = FALSE, linetype = FALSE),
                p3c + guides(color = FALSE, linetype = FALSE),
                p3d + guides(color = FALSE, linetype = FALSE),
                p3e + guides(color = FALSE, linetype = FALSE),
