...
```{r, GWAS1-unzip}
system(paste0("unzip ", datdir, "BMI.SNPadjSMK.zip"))
system(paste0("rm ", "BMI.SNPadjSMK.Women.EuropeanOnly.txt"))
system(paste0("rm ", "BMI.SNPadjSMK.Women.AllAncestry.txt"))
system(paste0("rm ", "BMI.SNPadjSMK.Men.EuropeanOnly.txt"))
system(paste0("rm ", "BMI.SNPadjSMK.Men.AllAncestry.txt"))
system(paste0("rm ", "BMI.SNPadjSMK.CombinedSexes.AllAncestry.txt"))
system(paste0("mv BMI.SNPadjSMK.CombinedSexes.EuropeanOnly.txt ", datdir))
system(paste0("rm -f ", datdir, "/*.zip"))
```
...
```{r, GWAS1-refdata}
# remove remnants of previous runs, if present
system(paste0("rm -f ", datdir, "/*CEU_MAF0.01*"))
...
download.file(url="http://neurogenetics.qimrberghofer.edu.au/iSECA/1000G_20101123_v3_GIANT_chr1_23_minimacnamesifnotRS_CEU_MAF0.01.zip", 
              destfile=paste0(datdir, "1000G_20101123_v3_GIANT_chr1_23_minimacnamesifnotRS_CEU_MAF0.01.zip"))

# unzip reference data
system(paste0("unzip ", datdir, "1000G_20101123_v3_GIANT_chr1_23_minimacnamesifnotRS_CEU_MAF0.01.zip -d ", datdir))
system(paste0("rm ", datdir, "1000G_20101123_v3_GIANT_chr1_23_minimacnamesifnotRS_CEU_MAF0.01.zip"))
```
