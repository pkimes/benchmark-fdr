...
```{r plottingResults}
rejections_scatter( sGSEA, as_fraction=FALSE )

stopifnot( all(assays(sGSEA)[["qvalue"]][,"unadjusted"] == pmin(goRes$over_represented_pvalue, 1) ) )
rowData(sGSEA)$numInCat <- goRes$numInCat

rejection_scatter_bins( sGSEA, "numInCat", threshold=15, bins=4, as_fraction=TRUE )
```
