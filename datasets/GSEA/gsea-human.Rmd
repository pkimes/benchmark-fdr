...
The objective of this document is to test different multiple testing methods in the context of Gene Set Enrichment Analysis (GSEA). In order to get a list of genes, we will use RNA-seq data consisting on cortex and cerebellum samples of a subset of the GTEx data. 
