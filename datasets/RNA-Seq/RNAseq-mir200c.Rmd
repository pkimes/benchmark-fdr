...
Similarly to the GTEx dataset, keeping all the tests results in a strange discretness. This is removed once we filter very lowly expressed genes. For the first covariate bin, however, there is a strange behaviour in which the distribution seems a bit skewed towards larger p-values. 
