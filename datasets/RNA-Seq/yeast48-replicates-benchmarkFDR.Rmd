...
system("mkdir -p yeast48-results")

if (!file.exists("yeast48-results/null5.rds")){
  null5 <- mclapply(X=1:B, FUN=simulateOneSplit, rseed=rseed, dds=dds, 
                   resFULL=resFULL, nDE=nDE, sampleSize=sampleSize, bd=bd,
                   mc.cores=cores)
  saveRDS(null5, file="yeast48-results/null5.rds")
}else{
  null5 <- readRDS(file="yeast48-results/null5.rds")
}
...
if (!file.exists("yeast48-results/null10.rds")){
  null10 <- mclapply(X=1:B, FUN=simulateOneSplit, rseed=rseed, dds=dds, 
                   resFULL=resFULL, nDE=nDE, sampleSize=sampleSize, bd=bd,
                   mc.cores=cores)
  saveRDS(null10, file="yeast48-results/null10.rds")
}else{
  null10 <- readRDS(file="yeast48-results/null10.rds")
}
...
if (!file.exists("yeast48-results/de5.rds")){
  de5 <- mclapply(X=1:B, FUN=simulateOneSplit, rseed=rseed, dds=dds, 
                   resFULL=resFULL, nDE=nDE, sampleSize=sampleSize, bd=bd,
                   mc.cores=cores)
  saveRDS(de5, file="yeast48-results/de5.rds")
}else{
  de5 <- readRDS(file="yeast48-results/de5.rds")
}
```
...
if(!file.exists("yeast48-results/de10.rds")){
  de10 <- mclapply(X=1:B, FUN=simulateOneSplit, rseed=rseed, dds=dds, 
                   resFULL=resFULL, nDE=nDE, sampleSize=sampleSize, bd=bd,
                   mc.cores=cores)
  saveRDS(de10, file="yeast48-results/de10.rds")
}else{
  de10 <- readRDS(file="yeast48-results/de10.rds")
}
```
