...
resfile_n5 <- file.path(resdir, "yeastII-results-null5.rds")
resfile_n10 <- file.path(resdir, "yeastII-results-null10.rds")
resfile_d5 <- file.path(resdir, "yeastII-results-de5.rds")
resfile_d10 <- file.path(resdir, "yeastII-results-de10.rds")
resfile_d5_uw <- file.path(resdir, "yeastIIU-results-de5.rds")
resfile_d10_uw <- file.path(resdir, "yeastIIU-results-de10.rds")

resfile_n5_uninfCov <- file.path(resdir, "yeastII-results-null5-uninfCov.rds")
resfile_n10_uninfCov <- file.path(resdir, "yeastII-results-null10-uninfCov.rds")
...
resfile_d5_uninfCov_uw <- file.path(resdir, "yeastIIU-results-de5-uninfCov.rds")
resfile_d10_uninfCov_uw <- file.path(resdir, "yeastIIU-results-de10-uninfCov.rds")
...
First, here's a function that will generate sampling weights for test statistics
