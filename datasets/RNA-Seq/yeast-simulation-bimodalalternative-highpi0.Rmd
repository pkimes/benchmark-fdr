...
resfile_d5_uninfCov_w <- file.path(resdir, "yeastIIHW-results-de5-uninfCov.rds")
resfile_d10_uninfCov_w <- file.path(resdir, "yeastIIHW-results-de10-uninfCov.rds")
