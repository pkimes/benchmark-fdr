...
## Analysis with DESeq2 & FDR Benchmarking
...
### Full analysis (48 vs 48 non-null)
...
geneExp <- geneExp %>% na.omit() %>% dplyr::filter(ind_covariate>=0)
...
log2FC[DE] <- rtruncnorm(nDE, 0.5, sd=0.5) * sample(c(1,-1), size=nDE, replace=TRUE)
