...
We download a DESeqDataSet object containing gene level counts for a subset of the GTEx data. The data set includes females and two cell types, nucleus accumbens and the putamen.
...
These discreteness, however, corresponded to genes with very low expression values. For example, there were `r nrow(dplyr::filter(res, ind_covariate <= 1))` genes with less than an average of 1 read across the 20 samples. The distribution of p-values looked much better when removing this very lowly expressed genes. 
