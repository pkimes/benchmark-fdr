...
In this Rmd we will carry out the steps in `yeast48-benchmarkFDR.Rmd` for multiple
...
download.file(url = "https://github.com/bartongroup/profDGE48/raw/master/Preprocessed_data/Snf2_countdata.tar.gz",
              destfile = paste0(datdir, "/Snf2_countdata.tar.gz"))
download.file(url = "https://github.com/bartongroup/profDGE48/raw/master/Preprocessed_data/WT_countdata.tar.gz", 
              destfile = paste0(datdir, "/WT_countdata.tar.gz"))

gunzip(paste0(datdir, "/Snf2_countdata.tar.gz")) 
gunzip(paste0(datdir, "/WT_countdata.tar.gz")) 

untar(paste0(datdir, "/Snf2_countdata.tar"), exdir = datdir) 
untar(paste0(datdir, "/WT_countdata.tar"), exdir = datdir) 

file.remove(paste0(datdir, "/Snf2_countdata.tar"), 
            paste0(datdir, "/WT_countdata.tar"))
```
...
knowckout samples. The fold changes observed in this comparison will be used when 
...
sampleSize <- 5
nDE <- 0
resfile <- paste0(resdir, "/null5.rds")
...
covariateHeatmap(null5, alpha=0.05, covname="log2FC", trans="log1p")
covariateHeatmap(null5, alpha=0.05, covname="ind_covariate", trans="log1p")

covariateHeatmap(null5, alpha=0.05, covname="log2FC", nbins=25, 
                 trans="log1p", linePlot = TRUE)
covariateHeatmap(null5, alpha=0.05, covname="ind_covariate", nbins=25, 
                 linePlot = TRUE, trans="log1p")
...
sampleSize <- 10
nDE <- 0
resfile <- paste0(resdir, "/null10.rds")
...
covariateHeatmap(null10, alpha=0.05, covname="log2FC", trans="log1p")
covariateHeatmap(null10, alpha=0.05, covname="ind_covariate", trans="log1p")

covariateHeatmap(null10, alpha=0.05, covname="log2FC", nbins=25, 
                 trans="log1p", linePlot = TRUE)
covariateHeatmap(null10, alpha=0.05, covname="ind_covariate", nbins=25, 
                 linePlot = TRUE, trans="log1p")
...
covariateHeatmap(de5, alpha=0.05, covname="log2FC", trans="log1p")
covariateHeatmap(de5, alpha=0.05, covname="ind_covariate")

covariateHeatmap(de5, alpha=0.05, covname="log2FC", nbins=25, 
                 trans="log1p", linePlot = TRUE)
covariateHeatmap(de5, alpha=0.05, covname="ind_covariate", nbins=25, 
                 linePlot = TRUE)
...
sampleSize <- 10
nDE <- 500
resfile <- paste0(resdir, "/de10.rds")
...
covariateHeatmap(de10, alpha=0.05, covname="log2FC", trans="log1p")
covariateHeatmap(de10, alpha=0.05, covname="ind_covariate")

covariateHeatmap(de10, alpha=0.05, covname="log2FC", nbins=25, 
                 trans="log1p", linePlot = TRUE)
covariateHeatmap(de10, alpha=0.05, covname="ind_covariate", nbins=25, 
                 linePlot = TRUE)
