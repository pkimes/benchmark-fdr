---
title: "Simulation Study: Informative Covariate (step)"
...
gauss_file <- file.path(resdir, "informative-step-benchmark-gaussian.rds")
tdist_file <- file.path(resdir, "informative-step-benchmark-t5.rds")
tdist11_file <- file.path(resdir, "informative-step-benchmark-t11.rds")
chisq_file <- file.path(resdir, "informative-step-benchmark-chisq4.rds")
