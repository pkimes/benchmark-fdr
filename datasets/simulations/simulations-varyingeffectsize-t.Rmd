---
title: "Simulation Study: Varying Effect Size (t noise)"
...
presented in `simulations-varyingeffectsize.Rmd`, however, t-distributed noise
is used to perturb effects.
...
spiky_file <- file.path(resdir, "varyinges-t-benchmark-spiky.rds")
flattop_file <- file.path(resdir, "varyinges-t-benchmark-flattop.rds")
skew_file <- file.path(resdir, "varyinges-t-benchmark-skew.rds")
bimodal_file <- file.path(resdir, "varyinges-t-benchmark-bimodal.rds")
...
Since all simulation settings in this case study use t-distributed noise, we must specify
the number of degrees of freedom for ASH. We add an additional parameter to the `ashq`
method with the corresponding degrees of freedom of the noise distribution.
