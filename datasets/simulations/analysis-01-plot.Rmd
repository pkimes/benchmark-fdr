...
dl <- c(list.dirs("data-tsim/M1", recursive=FALSE, full.names=TRUE),
        list.dirs("data-psim/M1", recursive=FALSE, full.names=TRUE))        
...
```{r}
## list of results from 100 replication experiments
dl <- c(list.dirs("data-tsim/M100", recursive=FALSE, full.names=TRUE),
        list.dirs("data-psim/M100", recursive=FALSE, full.names=TRUE))

for (dd in dl) {
    fl <- list.files(dd, pattern="M100\\.rds", full.names=TRUE)
