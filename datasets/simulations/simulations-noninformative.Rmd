...
```{r gauss-parameters}
tstat <- rnorm_generator(2)       # functional: dist of alternative test stats
...
We plot the averaged results across `r B` simulations.
...
```{r t5-parameters}
tstat <- rnorm_generator(5)    # functional: dist of alternative test stats
