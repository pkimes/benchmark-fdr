...
re_blabel <- function(tab) {
    tsb %>%
        mutate(blabel = fct_recode(f = blabel, "IHW" = "ihw-a05", "ASH" = "ashs",
               ...
               takes_cov = blabel %in%
                   c("IHW", "ASH", "Boca-Leek", "FDRreg (theoretical)", "FDRreg (empirical)")) %>%
...
<!-- ######################################################################## -->
### Boca-Leek Style Informative Covariate
