...
info00_file <- file.path(resdir, "varyinginfo-lowsignal-benchmark-level00.rds")
info20_file <- file.path(resdir, "varyinginfo-lowsignal-benchmark-level20.rds")
info40_file <- file.path(resdir, "varyinginfo-lowsignal-benchmark-level40.rds")
info60_file <- file.path(resdir, "varyinginfo-lowsignal-benchmark-level60.rds")
info80_file <- file.path(resdir, "varyinginfo-lowsignal-benchmark-level80.rds")
info100_file <- file.path(resdir, "varyinginfo-lowsignal-benchmark-level100.rds")
