...
in the setting as described in `simulations-informative-cubic.Rmd`. 
...
```{r null80-parameters}
pi0 <- pi0_cubic(0.80)             # numeric: proportion of null hypotheses
seed <- 608
```
...
```{r null95-parameters}
pi0 <- pi0_cubic(0.95)             # numeric: proportion of null hypotheses
seed <- 913
```
...
```{r null99-parameters}
pi0 <- pi0_cubic(0.99)             # numeric: proportion of null hypotheses
seed <- 2015
```
