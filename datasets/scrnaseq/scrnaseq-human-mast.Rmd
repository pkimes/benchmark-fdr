---
title: "Case Study: scRNA-seq (Human data, MAST method)"
...
explore the human dataset analysed with MAST.
...
```{r}
datfile <- paste0(datdir, "human_GSE84465_mast.rds")
...
humandata <- compute_MAST_sc(humandata)
...
strat_hist(data.frame(rowData(humandata)), 
           pvalue="mast_p", covariate="meanExp", maxy=35,
...
```{r, fig.width=10, fig.height=3.2, message=FALSE}
strat_hist(data.frame(rowData(humandata)), 
           pvalue="mast_p", covariate="detection", maxy=35,
...
res1 <- paste0(resdir, "sb_GSE84465_mast_mean.rds")
...
res2 <- paste0(resdir, "sb_GSE84465_mast_det.rds")
