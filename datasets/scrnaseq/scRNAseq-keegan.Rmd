...
humandata2 <- add_covariates_scrnaseq(humandata2)
mousedata <- add_covariates_scrnaseq(mousedata)
mousedata2 <- add_covariates_scrnaseq(mousedata2)
...
For each covariate, we'll examine the plots for each of the three analysis methods.
...
rank_scatter(data.frame(rowData(humandata)), 
  ...
  ggtitle("Wilcox, Covariate 1: Mean Expression")
rank_scatter(data.frame(rowData(humandata2)), 
             pvalue="wilcox_p", covariate="meanExp") + 
  ggtitle("Wilcox, Covariate 1: Mean Expression")
rank_scatter(data.frame(rowData(mousedata)), 
             pvalue="wilcox_p", covariate="meanExp") + 
  ggtitle("Wilcox, Covariate 1: Mean Expression")
rank_scatter(data.frame(rowData(mousedata2)), 
             pvalue="wilcox_p", covariate="meanExp") + 
  ggtitle("Wilcox, Covariate 1: Mean Expression")
```
...
strat_hist(data.frame(rowData(humandata)), 
           pvalue="wilcox_p", covariate="meanExp", maxy=25) 
strat_hist(data.frame(rowData(humandata2)), 
           pvalue="wilcox_p", covariate="meanExp", maxy=25) 
strat_hist(data.frame(rowData(mousedata)), 
           pvalue="wilcox_p", covariate="meanExp", maxy=25) 
strat_hist(data.frame(rowData(mousedata2)), 
           pvalue="wilcox_p", covariate="meanExp", maxy=25) 
```
...
rank_scatter(data.frame(rowData(humandata)), 
  ...
  ggtitle("Wilcox, Covariate 2: Detection Rate")
rank_scatter(data.frame(rowData(humandata2)), 
             pvalue="wilcox_p", covariate="detection") + 
  ggtitle("Wilcox, Covariate 2: Detection Rate")
rank_scatter(data.frame(rowData(mousedata)), 
...
```{r, fig.width=10, fig.height=3.2, message=FALSE}
strat_hist(data.frame(rowData(humandata)), 
           pvalue="wilcox_p", covariate="detection", maxy=25) 
strat_hist(data.frame(rowData(humandata2)), 
           pvalue="wilcox_p", covariate="detection", maxy=25) 
strat_hist(data.frame(rowData(mousedata)), 
           pvalue="wilcox_p", covariate="detection", maxy=25) 
...
We will skip running the Wilcox method for now.
