...
datfile <- paste0(datdir, "GSE84465.rds")
...
We'll compare the Immune cells in the tumor vs periphery.
...
if (!file.exists(datfile)){
  ...
  humandata <- humandata[, (colData(humandata)$tissue.ch1 %in% 
                         c(" Tumor", " Periphery")) &
                         colData(humandata)$cell.type.ch1 == " Immune cell" ]
