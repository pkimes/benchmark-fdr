...
core <- as.numeric(Sys.getenv("SLURM_NTASKS"))
...
```{bash, humandata-download}

download.file(url="http://imlspenticton.uzh.ch/robinson_lab/conquer/data-mae/GSE63818-GPL16791.rds",destfile=paste0(datdir,"GSE63818-GPL16791.rds")) 

download.file(url="http://imlspenticton.uzh.ch/robinson_lab/conquer/data-mae/GSE84465.rds",destfile=paste0(datdir,"GSE84465.rds"))

```

Next, we download the Mouse data:GSE45719

```{bash, mousedata-download}

download.file(url="http://imlspenticton.uzh.ch/robinson_lab/conquer/data-mae/GSE45719.rds",destfile=paste0(datdir,"GSE45719.rds")) 

download.file(url="http://imlspenticton.uzh.ch/robinson_lab/conquer/data-mae/GSE94383.rds",destfile=paste0(datdir,"GSE94383.rds"))
...
saveRDS(g_cdata_sub,paste0(datdir,"h_g_nofilter_subcdata_GSE63818-GPL16791.rds"))# removing rows with all zeros reduces the number of genes to 33169
...
g_data=cbind(g1_data,g2_data)
g_data_sub=g_data[rowSums(g_data==0)!=dim(g_data)[2],] # 0.25*52=13
saveRDS(g_data_sub,paste0(datdir,"m_g_nofilter_subdata_GSE94383.rds")) # removing rows with all zeros reduces the number of genes to 25179

g_cdata=cbind(g1_cdata,g2_cdata)
g_cdata_sub=g_cdata[rowSums(g_cdata==0)!=dim(g_data)[2],]
saveRDS(g_cdata_sub,paste0(datdir,"m_g_nofilter_subcdata_GSE94383.rds")) # removing rows with all zeros reduces the number of genes to 25179

saveRDS(g1_ids,paste0(datdir,"m_g1_ids_GSE94383.rds"))
saveRDS(g2_ids,paste0(datdir,"m_g2_ids_GSE94383.rds"))
```
