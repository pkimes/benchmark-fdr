...
```{r}
datfile <- paste0(datdir, "mouse_GSE94383_mast.rds")
...
strat_hist(data.frame(rowData(mousedata)),
           pvalue="mast_p", covariate="meanExp", maxy=16,
...
```{r, fig.width=10, fig.height=3.2, message=FALSE}
strat_hist(data.frame(rowData(mousedata)), 
           pvalue="mast_p", covariate="detection", maxy=16,
...
res1 <- paste0(resdir, "sb_GSE94383_mast_mean.rds")
...
res2 <- paste0(resdir, "sb_GSE94383_mast_det.rds")
