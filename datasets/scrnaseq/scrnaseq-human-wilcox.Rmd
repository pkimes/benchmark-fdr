...
We also apply three different analysis methods: the non-parametric Wilcoxon Rank-sum test, Wilcoxon_Ranksum [@finak2015] and scDD [@korthauer2016]. 
...
res1 <- file.path(resdir, "sb_GSE84465_Wilcoxon_Ranksum_mean.rds")
...
res2 <- file.path(resdir, "sb_GSE84465_Wilcoxon_Ranksum_det.rds")
