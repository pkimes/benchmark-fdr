...
We also apply two different analysis methods: Wilcoxon-ranksum [@finak2015] and scDD [@korthauer2016]. 
In this vignette, we will explore the human dataset analysed with Wilcoxon-ranksum.
