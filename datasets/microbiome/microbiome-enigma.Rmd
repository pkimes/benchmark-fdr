...
We download the data from Dropbox if not already available.

```{r, enigma-download-data}
if (!file.exists(file.path(enigma_dir, "enigma.metadata.txt"))) {
    download.file("https://www.dropbox.com/s/0r1zjp26u10l0p4/enigma.metadata.txt?dl=1",
...
if (!file.exists(file.path(enigma_dir, "enigma.otu_table_resampled_updated_r.txt.gz"))) {
    download.file("https://www.dropbox.com/s/u9qh86cd7c0vbn9/enigma.otu_table_resampled_updated_r.txt.gz?dl=1",
...
print(file.path(enigma_dir, "enigma.otu_table_resampled_updated_r.txt.gz"))
...
```{r}
plotMethodRanks(c(so4_bench_file, so4_bench_file_abun,
                  ph_bench_file, ph_bench_file_abun,
                  al_bench_file, al_bench_file_abun), 
                colLabels = c("SO4", "SO4-abun", "pH", "ph-abun",
                              "Al", "Al-abun"), 
