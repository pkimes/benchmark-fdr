...
otu_bench_file <- file.path(resdir, "baxter-otus-benchmark.rds")
otu_bench_file_log_ubiquity <- file.path(resdir, "baxter-otus-log-ubiquity-benchmark.rds")

gns_result_file <- file.path(resdir, "baxter-genus-results.rds")
gns_bench_file <- file.path(resdir, "baxter-genus-benchmark.rds")
gns_bench_file_log_ubiquity <- file.path(resdir, "baxter-genus-log-ubiquity-benchmark.rds")
```
