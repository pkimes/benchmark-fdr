...
gns_bench_file_log_ubi <- file.path(resdir, "papa-genus-log-ubiquity-benchmark.rds")
gns_bench_file_abun <- file.path(resdir, "papa-genus-abun-benchmark.rds")
```
...
```{r, eval = FALSE}
plotMethodRanks(c(otu_bench_file, gns_bench_file, gns_bench_file_log_ubi), 
                colLabels = c("OTU", "Genus", "Genus - log ubiquity"), 
