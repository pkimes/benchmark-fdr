...
## TODO: less filtering! Keep as many hypotheses open as possible.
...
var <- "logubiquity"
g <- ggplot(goodrichdat, aes(x = get(var), y = logpval)) + geom_point()
g
```
...
```{r}
g <- ggplot(goodrichdat, aes(x = get(covcol), y = logpval)) + geom_point()
g
```
