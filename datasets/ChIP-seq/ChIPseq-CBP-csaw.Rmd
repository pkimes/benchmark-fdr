...
strat_hist(res_df, pvalue = "PValue", covariate = "uninf_covar", maxy = 35, numQ = 3)
```
...
plotFDRMethodsOverlap(sbU, alpha = 0.05, nsets = ncol(sb),
                      order.by = "freq", decreasing = TRUE,
                      supplementary = FALSE)
```
...
```{r}
plotMethodRanks(c(benchfile, benchfile_uninf), 
                colLabels = c("Region width", "Random"), 
